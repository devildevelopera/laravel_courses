...
return array (
  ...
  array (
    ...
    array (
      ...
      'timeout' => 'تم تسجيل خروجك تلقائيًا',
      'trashed' => 'سلة المهملات',
      'you_have' => 
      array (
        'messages' => '{0} ليس لديك رسائل | {1} لديك رسالة واحدة | [2 ، Inf] لديك: رسائل عدد',
        'notifications' => '{0} ليس لديك اشعارات | {1} لديك إشعار واحد | [2 ، Inf] لديك: اشعارات الأرقام',
    ...
    array (
      ...
      'auto_add_pages' => 'إضافة صفحات بشكل تلقائي',
  ...
  array (
    ...
    array (
      ...
      'trouble_clicking_button' => 'إذا كنت تواجه مشكلة في الضغط فوق الزر ": action_text" ، فانسخ والصق عنوان URL أدناه في متصفح الويب الخاص بك:',
    ),
    'contact' => 
    array (
